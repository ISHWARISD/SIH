...
const CaseDetails = () => {
  return (
    <div className="bg-white border-2 border-[#2B4C65] p-6 rounded-lg shadow-md">
      ...
      <p className="text-[#2B4C65] mb-2"><strong>Case ID:</strong> {caseDetails.caseId}</p>
      ...
      <p className="text-[#2B4C65] mb-2"><strong>Imprisonment Duration:</strong> {caseDetails.imprisonmentDuration}</p>
      <p className="text-[#2B4C65] mb-2"><strong>Hearing Dates:</strong> {caseDetails.hearingDates.join(', ')}</p>
      <p className="text-[#2B4C65] mb-2"><strong>Judge:</strong> {caseDetails.judge}</p>
      
      <h3 className="text-xl font-semibold text-[#2B4C65] mb-2">Bail Status:</h3>
      <p className="text-[#2B4C65] mb-4">{caseDetails.bailStatus}</p>

      <h3 className="text-xl font-semibold text-[#2B4C65] mb-2">Bail History:</h3>
      <ul className="list-disc list-inside mb-4 text-[#2B4C65]">
