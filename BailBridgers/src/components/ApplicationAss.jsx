...
const ApplicationAssistance = () => {
  return (
    <div className="bg-white border-2 border-[#00008B] p-6 rounded-lg shadow-md">
      ...
      <p className="text-[#2B4C65] mb-4">
        Follow these steps to prepare and submit your bail application:
      </p>

      <ol className="list-decimal list-inside text-[#2B4C65] space-y-2">
        <li>
      ...
      <div className="mt-6">
        <h3 className="text-xl font-semibold text-[#2B4C65] mb-2">Common Mistakes to Avoid:</h3>
        <ul className="list-disc list-inside text-[#2B4C65] ml-6">
      ...
      <div className="mt-6">
        <h3 className="text-xl font-semibold text-[#2B4C65] mb-2">Resources:</h3>
        <ul className="list-disc list-inside text-[#2B4C65] ml-6">
          <li>
